...
Use this folder as a simple drop zone for design inspiration.

Drop in screenshots, links, exported designs, `DESIGN.md` examples, Claude Design outputs, Stitch outputs, competitor notes, moodboards, and rough visual references.
